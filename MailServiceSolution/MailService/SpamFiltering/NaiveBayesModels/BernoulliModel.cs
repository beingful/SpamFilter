...
namespace MailService
{
    public class BernoulliModel : INaiveBayesModel
    {
        ...
        {
            return (double)(1 + numerator) / (denominator + 2);
        }
            ...
            where CategoryType : IEmailCategory, new()
        {
            ...
            total += Attributes
                ...
                .Sum(element =>
                {
                    ...
                    double probabilityLog = GetProbabilityLog((byte)element.Value, probability);

                    return GetProbabilityLog((byte)element.Value, probability);
                });
